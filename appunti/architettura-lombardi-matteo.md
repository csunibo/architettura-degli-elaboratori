    ...
    - **1.3 - Storia degli elaboratori**
        ...
        - **Generazione 1 - Computer basati su valvole**
            ...
            - **Architettura di Von Neumann**, sulla quale si baseranno quasi tutti gli elaboratori che verranno utilizzati in seguito.
                ...
                ![Screenshot (191).png](architettura-matteo-lombardi/Screenshot-(191).png)
    ...
    **John Von Neumann**, ideatore dell’architettura base dei computer odierni, utilizzava la memoria principale non solo per i dati ma anche per i programmi, evitando così configurazioni complesse con interruttori e cavi. Von Neumann utilizzava l’architettura **bus oriented**, la quale prevedeva un insieme di connessioni elettriche parallele utilizzate per trasportare informazioni da un componente ad un altro.
    ...
    - **2.1 - Processore**
        ...
        - **Multicore**
            ...
            ![Processore multicore.](architettura-matteo-lombardi/Screenshot-(278).png)
        ...
        - **Array computer**
            ...
            **SIMD**: Single Instruction-stream, Multiple Data-stream.
            ...
            ![Screenshot (195).png](architettura-matteo-lombardi/Screenshot-(195).png)
    ...
    - **2.2 - Memorie**
        ...
        ![Screenshot (198).png](architettura-matteo-lombardi/Screenshot-(198).png)
        ...
        ![Screenshot (200).png](architettura-matteo-lombardi/Screenshot-(200).png)
...
- **3.0 - Porte logiche e circuiti combinatori**
    ...
    - **3.2 - Tabella di verità e formula canonica**
        ...
        ![Esempio di tabella di verità-](architettura-matteo-lombardi/Screenshot-(206).png)
        ...
        - Un **mintermine** su n variabili corrisponde ad un AND logico tra n letterali corrispondenti alle n variabili.
            ...
            ![Esempio di mintermini di una funzione che forniscono come risultato 1.](architettura-matteo-lombardi/Screenshot-(212).png)
    ...
    - **3.3 - Porte logiche**
        ...
        **NOT con transistor**
        ...
        ![Screenshot (214).png](architettura-matteo-lombardi/Screenshot-(214).png)
        ...
        **NAND con transistor**
        ...
        ![Screenshot (215).png](architettura-matteo-lombardi/Screenshot-(215).png)
    ...
    - **3.4 - Mappa di Karnaugh e formula minimale**
        ...
        ![Screenshot (220).png](architettura-matteo-lombardi/Screenshot-(220).png)
        ...
        **Come ricavare la formula minimale dalla mappa di Karnaugh?**
        ...
        ![Screenshot (7).png](architettura-matteo-lombardi/Screenshot-(7).png)
...
- **5.0 - Circuiti sequenziali**
    ...
    - **5.2 - Flip-Flop**
        ...
        ![Screenshot (228).png](architettura-matteo-lombardi/Screenshot-(228).png)
        ...
        ![Il triangolo in basso indica che si tratta di un circuito temporizzato.](architettura-matteo-lombardi/Screenshot-(231).png)
...
- **6.0 - Microarchitettura**
    ...
    - **6.1 - Microarchitettura del processore Hack**
        ...
        ![Uso dei control bit per identificare l’operazione da svolgere.](architettura-matteo-lombardi/Screenshot-(300).png)
    ...
    - **6.2 - Organizzazione delle memorie**
        ...
        **Cache**
        ...
        - Prendiamo come esempio una direct mapped cache con 2048 linee (n) di dimensione 32 byte (m).
            ...
            ![Frame 2 (2).png](architettura-matteo-lombardi/Frame-2-(2).png)
    ...
    - **6.3 - Microarchitetture moderne, prefetch e pipeline**
        ...
        **Accesso concorrente ai registri in pipeline**
        ...
        ![Microarchitettura dell’Intel Core i7.](architettura-matteo-lombardi/Screenshot-(277).png)
        
        Microarchitettura dell’Intel Core i7.
        
        ![Percorso dati dell’Intel Core i7 (vista semplificata).](architettura-matteo-lombardi/Screenshot-(276).png)
        ...
        ![Struttura del microprocessore Intel Core i7-3960X.](architettura-matteo-lombardi/Screenshot-(278)%201.png)
...
- **7.0 - Livello ISA (Instruction Set Architecture)**
    ...
    - **7.2 - ISA (Instruction Set Architecture) generale**
        ...
        **Record di attivazione**
        ...
        - Il seguente è un esempio dell’implementazione e della gestione dei record di attivazione con il programma “Torre di Hanoi”.
            ...
            ![Stack dei record di attivazione in alcuni momenti dell’esecuzione del programma “Torre di Hanoi”.](architettura-matteo-lombardi/Screenshot-(283).png)
    ...
    - **7.3 - ISA (Instruction Set Architecture) del computer Hack**
        ...
        ![Struttura del computer Hack.](architettura-matteo-lombardi/Screenshot-(259).png)
        ...
        ![Screenshot (253).png](architettura-matteo-lombardi/Screenshot-(253).png)
        ...
        **Memoria per le istruzioni**
        ...
        ![ROM del computer Hack.](architettura-matteo-lombardi/Screenshot-(239).png)
        ...
        **Data memory**
        ...
        ![RAM del computer Hack.](architettura-matteo-lombardi/Screenshot-(240).png)
        ...
        **Keyboard memory**
        ...
        ![Chip tastiera del computer Hack.](architettura-matteo-lombardi/Screenshot-(243).png)
        ...
        **Input e output della CPU**
        ...
        ![Struttura interna della CPU.](architettura-matteo-lombardi/Screenshot-(260).png)
        
        Struttura interna della CPU.
        
        **Codifica delle A-instruction**
        
        ![Codifica delle A-instruction.](architettura-matteo-lombardi/Screenshot-(255).png)
        ...
        **Codifica delle C-instruction**
        ...
        ![Codifica delle C-instruction.](architettura-matteo-lombardi/Screenshot-(256).png)
        ...
        ![Screenshot (257).png](architettura-matteo-lombardi/Screenshot-(257).png)
    ...
    - **7.4 - Assemblatore**
        - **7.4.1 - Assemblatore del computer Hack**
            ...
            ![Esempio di input e output dell’assemblatore.](architettura-matteo-lombardi/Frame-1.png)
            ...
            **Traduzione di A-instruction**
            ...
            ![Codifica di una A-instruction.](architettura-matteo-lombardi/Screenshot-(1).png)
            ...
            **Traduzione di simboli (etichette e variabili)**
            ...
            ![2.png](architettura-matteo-lombardi/2.png)
...
- **8.0 - Sistema operativo**
    ...
    ![Struttura di un comune sistema UNIX.](architettura-matteo-lombardi/Screenshot-(286).png)
    ...
    - **8.1 - Paginazione**
        ...
        ![Screenshot (287).png](architettura-matteo-lombardi/Screenshot-(287).png)
        ...
        **Pagine e blocchi di memoria**
        ...
        ![a) Primi 64 KB degli indirizzi virtuali suddivisi in 16 pagine da 4 KB. b) Memoria principale da 32 KB suddivisa in otto blocchi di memoria da 4KB.](architettura-matteo-lombardi/Screenshot-(288).png)
        ...
        **Traduzione da indirizzo virtuale ad indirizzo reale**
        ...
        ![Formazione di un indirizzo fisico a partire da un indirizzo virtuale.](architettura-matteo-lombardi/Screenshot-(289).png)
    ...
    - **8.2 - Segmentazione**
        ...
        **Segmentazione**
        ...
        ![Esempio di segmentazione della memoria.](architettura-matteo-lombardi/Screenshot-(290).png)
        ...
        **Frammentazione esterna**
        ...
        ![(a - d) Incremento della frammentazione esterna. (e) Rimozione della frammentazione esterna tramite compattamento.](architettura-matteo-lombardi/Screenshot-(291).png)
        ...
        **Combinazione fra paginazione e segmentazione**
        ...
        ![Conversione di un indirizzo MULTICS a due parti in un indirizzo fisico.](architettura-matteo-lombardi/Screenshot-(292).png)
    ...
    - **8.3 - Collegamento di un programma**
        ...
        ![Generazione di un file eseguibile a partire da un gruppo di file sorgenti tradotti indipendentemente.](architettura-matteo-lombardi/Screenshot-(293).png)
        ...
        **Rilocazione**
        ...
        - I **riferimenti esterni**, ovvero indirizzamenti esterni al modulo oggetto in questione, vengono rilocati utilizzando una tecnica più complicata. Per farlo infatti si ha bisogno di informazioni aggiuntive rispetto al primo caso, quindi nella creazione di ogni modulo oggetto viene sempre inserito un **dizionario di rilocazione**, in cui vengono inseriti tutti gli indirizzi che sono potenzialmente da rilocare, e in questo modo il modulo A, quello da rilocare, indica al linker che usa il simbolo esterno nel modulo B, e il modulo B deve dire a che indirizzo interno corrisponde il simbolo che esporta. Con queste informazioni, più la tabella con gli indirizzi di inizio di ogni modulo, si riesce a rilocare in modo corretto i riferimenti esterni di ogni modulo.
            ...
            ![Composizione di un modulo oggetto prodotto da un compilatore.](architettura-matteo-lombardi/Screenshot-(294).png)
        ...
        - Facciamo l’esempio di un programma composto da 4 moduli, in ognuno dei quali vengono utilizzate le stesse 3 istruzioni BRANCH (istruzione di salto), MOVE (sposta dati da registri a memoria e viceversa) e CALL (invoca una procedura che si può anche trovare all’interno di un altro modulo oggetto). Come possiamo notare dalla figura ogni modulo ha il proprio spazio di indirizzi, che inizia da 0.
            ...
            ![Screenshot (295)-cleanup.png](architettura-matteo-lombardi/Screenshot-(295)-cleanup.png)
            ...
            ![a) I moduli oggetto dopo essere stati uniti nell’immagine binaria, ma prima di essere collegati e rilocati. b) Gli stessi moduli oggetto dopo aver effettuato il collegamento e la rilocazione.](architettura-matteo-lombardi/Screenshot-(296).png)
        ...
        **Rilocazione a tempo del binding**
        ...
        ![Programma dell’esempio precedente spostato di 300 posizioni. Deve essere rilocato in quanto molte istruzioni si riferiscono ora a indirizzi di memoria errati.](architettura-matteo-lombardi/Screenshot-(298).png)
...
- 9**.0 - Virtual Machine**
    ...
    ![Differenza tra compilazione diretta e compilazione a 2 livelli.](architettura-matteo-lombardi/Screenshot-(263).png)
    ...
    - **9.2 - Modello a stack**
        ...
        **Arithmetic/Boolean commands**
        ...
        ![Spiegazione dei comandi aritmetico/booleani della virtual machine.](architettura-matteo-lombardi/Screenshot-(305).png)
        ...
        **Memory access commands**
        ...
        ![Screenshot (268).png](architettura-matteo-lombardi/Screenshot-(268).png)
        ...
        **Function calling commands**
        ...
        - Presentiamo un esempio di funzione scritta in un linguaggio ad alto livello e tradotta nel linguaggio virtual machine appena visto. Vediamo anche come si comporta la memoria appena la funzione viene richiamata e subito dopo la sua esecuzione.
            ...
            ![Screenshot (307).png](architettura-matteo-lombardi/Screenshot-(307).png)
        ...
        **Organizzazione della memoria**
        ...
        ![Esempio del modello a stack per il comando **add**.](architettura-matteo-lombardi/Screenshot-(267).png)
    ...
    - **9.3 - Subroutine**
        ...
        ![Stack durante l’esecuzione della subroutine.](architettura-matteo-lombardi/Screenshot-(308).png)
        ...
        - Vediamo un esempio di catena di chiamate di funzione e di come viene gestito lo stack durante la loro esecuzione.
            ...
            ![Esempio di catena di chiamate.](architettura-matteo-lombardi/Screenshot-(309).png)
            
            Esempio di catena di chiamate.
            
            ![Evoluzione dello stack durante le chiamate.](architettura-matteo-lombardi/image.jpg)
